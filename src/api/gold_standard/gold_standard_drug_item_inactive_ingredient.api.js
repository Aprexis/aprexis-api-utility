...
export const goldStandardDrugItemInactiveIngredientApi = {
  listForDrugItem,
  profileForDrugItem,
  showForDrugItem
}
...
function listForDrugItem(credentials, drug_item_id, params, onSuccess, onFailure) {
  ...
  const method = 'GET'
  const path = `/gold_standard/drug_items/${drug_item_id}/drug_item_inactive_ingredients/list`
...
function profileForDrugItem(credentials, drug_item_id, ingredient_id, onSuccess, onFailure) {
  ...
  const method = 'GET'
  const path = `/gold_standard/drug_items/${drug_item_id}/drug_item_inactive_ingredients/${ingredient_id}/profile`
...
function showForDrugItem(credentials, drug_item_id, ingredient_id, onSuccess, onFailure) {
  ...
  const method = 'GET'
  const path = `/gold_standard/drug_items/${drug_item_id}/drug_item_inactive_ingredients/${ingredient_id}`
  API.perform(method, path, '', credentials, undefined, onSuccess, onFailure)
}
